              ...
              <div className="flex justify-between items-center text-xs pt-1 border-t border-slate-800/80">
                ...
                {order.order_status === 'Assigned' && order.assignment_status !== 'Accepted' ? (
                  <button
                    ...
                    className="px-3 py-1.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-xl text-xs flex items-center space-x-1 shadow-sm transition-all"
                  >
                    <span>Accept</span>
