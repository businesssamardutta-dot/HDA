...
-- Create basic permissive policies for authenticated and anon users
CREATE POLICY "Public Read All" ON public."01_orders" FOR SELECT USING (true);
CREATE POLICY "Public Insert All" ON public."01_orders" FOR INSERT WITH CHECK (true);
CREATE POLICY "Public Update All" ON public."01_orders" FOR UPDATE USING (true);

CREATE POLICY "Public Read Customers" ON public."01_customers" FOR ALL USING (true);
CREATE POLICY "Public Read Delivery Boys" ON public."01_delivery_boys" FOR ALL USING (true);
CREATE POLICY "Public Read Products" ON public."01_products" FOR ALL USING (true);
CREATE POLICY "Public Read Zones" ON public."01_zones" FOR ALL USING (true);
CREATE POLICY "Public Read Notifications" ON public."01_notifications" FOR ALL USING (true);
